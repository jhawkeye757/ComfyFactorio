...
function get_biter()
    local max_chance = 0
    for i = 1, 4, 1 do
        max_chance = max_chance + storage.enemy_appearances[i].chance
    end
    local r = math.random(1, max_chance)
    local current_chance = 0
    for i = 1, 4, 1 do
        current_chance = current_chance + storage.enemy_appearances[i].chance
        if r <= current_chance then
            return storage.enemy_appearances[i].biter
        end
    end
end
...
function get_spitter()
    ...
    for i = 1, 4, 1 do
        current_chance = current_chance + storage.enemy_appearances[i].chance
        if r <= current_chance then
            return storage.enemy_appearances[i].spitter
        end
    end
end
...
function get_worm()
    ...
    for i = 1, 4, 1 do
        current_chance = current_chance + storage.enemy_appearances[i].chance
        if r <= current_chance then
            return storage.enemy_appearances[i].worm
        end
    end
end
...
function get_ammo()
    ...
    for i = 1, 4, 1 do
        current_chance = current_chance + storage.enemy_appearances[i].chance
        if r <= current_chance then
            return storage.enemy_appearances[i].ammo
        end
    end
end
